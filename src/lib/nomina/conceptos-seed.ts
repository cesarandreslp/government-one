...
// editable por tenant una vez sembrado. Retención en la fuente (Art. 383 ET, tabla real — ver
// motor.ts) y auxilio por incapacidad (66.67% desde el día 3, Ley 100/1993 Art. 227) se calculan
// con lógica propia, no con porcentaje/fijo genérico — por eso sus conceptos no traen
// `porcentaje`/`valorFijo`. Prima de servicios se mensualiza como aproximación (8.33%) en vez del
...
export interface ConceptoNominaSeed {
  ...
  formula: "FIJO" | "PORCENTAJE_SUELDO" | "PORCENTAJE_IBC" | "PORCENTAJE_DEVENGADO" | "RETENCION_FUENTE" | "AUXILIO_INCAPACIDAD"
  porcentaje?: number
  valorFijo?: number
...
export const CONCEPTOS_NOMINA: ConceptoNominaSeed[] = [
  ...
  { codigo: "NC-004", nombre: "Auxilio por Incapacidad", tipo: "DEVENGADO", formula: "AUXILIO_INCAPACIDAD", cuentaContableCodigo: "510105", orden: 40 },
  ...
  { codigo: "NC-103", nombre: "Retención en la Fuente", tipo: "DEDUCCION", formula: "RETENCION_FUENTE", cuentaContableCodigo: "243601", orden: 130 },
